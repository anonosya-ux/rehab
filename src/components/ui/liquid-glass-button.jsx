...
export const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-2xl text-sm font-medium hover:scale-105 active:scale-95 transition-[transform,color,box-shadow] duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-transparent text-primary-900",
      ...
      size: {
        ...
        xxl: "h-16 px-10 text-lg has-[>svg]:px-8",
        icon: "size-9",
      },
    },
    defaultVariants: {
    ...
    <>
      ...
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-2xl 
            shadow-[0_0_15px_rgba(255,255,255,0.4),0_10px_20px_rgba(0,0,0,0.1),inset_2px_2px_0_rgba(255,255,255,0.6),inset_-2px_-2px_0_rgba(0,0,0,0.1)] 
        transition-all bg-white/40 group-hover:bg-white/60 backdrop-blur-md border border-white" />
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-2xl"
          style={{ backdropFilter: 'url("#container-glass")' }}
        />

        <div className="pointer-events-none z-10 font-bold text-primary-900 tracking-wide drop-shadow-[0_2px_20px_rgba(255,255,255,1)]">
          {children}
        </div>
        <GlassFilter />
      </Comp>
