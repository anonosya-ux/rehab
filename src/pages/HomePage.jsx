...
export default function HomePage() {
  return (
    <>
      ...
      <section className="section-padding" id="boslab-teaser">
      ...
      {/* Location Section */}
      <section className="section-padding bg-surface-darker/50" id="location-section">
        <div className="container-main">
      ...
      {/* Final CTA */}
      <section className="section-padding" id="final-cta">
        <div className="container-main">
          <div className="relative overflow-hidden rounded-3xl p-8 md:p-12 lg:p-16 bg-gradient-to-r from-accent-600/20 to-primary-600/20 border border-accent-400/10 text-center">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-accent-500 to-accent-400 text-white font-semibold text-lg hover:shadow-glow transition-all duration-300 hover:-translate-y-1">
