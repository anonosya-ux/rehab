    ...
    <div className="w-full pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="container-main relative z-10">
        <div className="text-center mb-24 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-playfair font-bold text-primary-900 mb-8 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
          <div className="aspect-square bg-surface-darker/50 border border-surface-dark rounded-[3rem] p-8 flex items-center justify-center relative overflow-hidden">
            ...
            <h2 className="text-4xl font-playfair font-bold text-primary-900/20 text-center relative z-10">Здесь должно быть видео/фото реального центра</h2>
          </div>
          <div>
            <h2 className="text-4xl font-playfair font-bold text-primary-900 mb-6">Наша философия</h2>
            ...
            <div className="flex gap-4">
               <a href="/o-centre/vrachi" className="px-6 py-3 rounded-xl bg-surface-dark/10 hover:bg-white/20 text-primary-900 font-medium transition-colors border border-surface-dark">
                 Наша команда
               </a>
               <a href="/o-centre/licenzii" className="px-6 py-3 rounded-xl bg-surface-muted hover:bg-surface-dark/10 text-primary-900/80 font-medium transition-colors border border-transparent hover:border-surface-dark">
                 Лицензии
               </a>
            </div>
          </div>
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-8 glass rounded-[2rem] border border-surface-dark mb-32">
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-playfair font-bold text-primary-400 mb-2">10+</div>
            <div className="text-sm text-text-muted uppercase tracking-widest font-semibold">Лет успешной работы</div>
          </div>
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-playfair font-bold text-primary-400 mb-2">14+</div>
            <div className="text-sm text-text-muted uppercase tracking-widest font-semibold">Специалистов в штате</div>
          </div>
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-playfair font-bold text-primary-400 mb-2">90%</div>
            <div className="text-sm text-text-muted uppercase tracking-widest font-semibold">Стойкая ремиссия</div>
          </div>
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-playfair font-bold text-primary-400 mb-2">24/7</div>
            <div className="text-sm text-text-muted uppercase tracking-widest font-semibold">Горячая линия поддержки</div>
          </div>
        </div>
