        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
          ...
          <div>
            ...
            <div className="flex gap-4">
               <a href="/o-centre/vrachi" className="px-6 py-3 rounded-xl bg-white/10 hover:bg-white/20 text-white font-medium transition-colors border border-white/10">
                 Наша команда
               </a>
               <a href="/o-centre/licenzii" className="px-6 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white/80 font-medium transition-colors border border-transparent hover:border-white/10">
                 Лицензии
               </a>
            </div>
          </div>
